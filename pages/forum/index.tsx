...
export default function Forum() {
  return (
    <div className="bg-white shadow overflow-hidden sm:rounded-md min-h-screen">
      <div className="py-16 px-4 sm:py-24 sm:px-6 desktop:px-8 bg-gray-100">
        <div className="text-center">
          <h2 className="text-base font-semibold text-green-600 tracking-wide uppercase">
            Lorem Ipsum Dolor
          </h2>
          <p className="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight desktop:text-6xl">
            Forum
          </p>
