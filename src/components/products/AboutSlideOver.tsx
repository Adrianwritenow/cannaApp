      ...
      <section aria-labelledby="business-about" className="pt-2">
        ...
        <div className="pt-5 ">
          <button
            ...
            className="py-4 w-full uppercase text-green-500 text-xs font-semibold border-t border-gray-200 tracking-widest hidden lg:hidden"
          >
            Learn more
          </button>
        </div>
        ...
        <button
          className="p-4 hidden lg:flex rounded-md bg-green-100 w-max  text-green-600 text-sm font-semibold border-gray-200"
          onClick={() => setOpen(true)}
        >
