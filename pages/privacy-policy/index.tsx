      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="text-lg mx-auto prose">
          <h1 className="flex-wrap flex">
            ...
            <span className="mt-2 block w-full text-3xl text-start font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Privacy policy
            </span>
        ...
        <div className="prose prose-green text-gray-500 mx-auto">
          <div className="small-12 columns">
            <section>
              <h3>Introduction</h3>
              <p>
                <em>
                  CANNAPAGES (“we” or “us” or “our”) respects the privacy of our
                  users (“user” or “you”). This Privacy Policy explains how we
                  collect, use, disclose, and safeguard your information when
                  you visit our website [name of website.com] [and our mobile
                  application], including any other media form, media channel,
            ...
            <section>
              ...
              <p>
                <em>
                  ...
                  hometown, and interests, that you voluntarily give to us when
                  you register with the Site or our mobile application, or when
                  ...
                  so may prevent you from using certain features of the Site and
              ...
              <p>
                <em>
                  ...
                  when you access the Site, such as your IP address, your
                  browser type, your operating system, your access times, and
                  the pages you have viewed directly before and after accessing
                  the Site. If you are using our mobile application, this
                  information may also include your device name and type, your
                  operating system, your phone number, your country, your likes
                  and replies to a post, and other interactions with the
              ...
              <p>
                <em>
                  Facebook Permissions The Site and our mobile application may
                  by default access your Facebook basic account information,
                  including your name, email, gender, birthday, current city,
                  and profile picture URL, as well as other information that you
                  choose to make public. We may also request access to other
                  permissions related to your account, such as friends,
                  checkins, and likes, and you may choose to grant or deny us
                  access to each individual permission. For more information
              ...
              <p>
                <em>
                  ...
                  networking sites, such as [Apple’s Game Center, Facebook,
                  Google+, Instagram, Pinterest, Twitter], including your name,
                  your social network username, location, gender, birth date,
                  email address, profile picture, and public data for contacts,
                  if you connect your account to such social networks. If you
                  are using our mobile application, this information may also
                  include the contact information of anyone you invite to use
              ...
              <p>
                <em>
                  ...
                  device ID, model, and manufacturer, and information about the
                  location of your device, if you access the Site from a mobile
                  device.
                </em>
              </p>
              ...
              <p>
                <em>
                  ...
                  information you may provide when entering contests or
              ...
              <ul>
                ...
                <li>
                  <em>
                    Mobile Device Data. We may collect device information (such
                    as your mobile device ID, model and manufacturer), operating
            ...
            <section>
              ...
              <p>
                <em>
                  ...
                  the Site [or our mobile application] to:
                </em>
              </p>

              <ul>
                <li>
                  <em>Administer sweepstakes, promotions, and contests.</em>
                </li>
                <li>
                  <em>Assist law enforcement and respond to subpoena.</em>
                </li>
                <li>
                  <em>
                ...
                <li>
                  <em>Create and manage your account.</em>
                </li>
                <li>
                  <em>
                ...
                <li>
                  <em>Email you regarding your account or order.</em>
                </li>
                <li>
                  <em>Enable user-to-user communications.</em>
                </li>
                <li>
                  <em>
                    Fulfill and manage purchases, orders, payments, and other
                    transactions related to the Site [and our mobile
                    application].
                  </em>
                </li>
                <li>
                  <em>
                    ...
                    to the Site [and our mobile application] more personalized.
                  </em>
                </li>
                <li>
                  <em>
                ...
                <li>
                  <em>Perform other business activities as needed.</em>
                </li>
                <li>
                  <em>
                ...
                <li>
                  <em>Process payments and refunds.</em>
                </li>
                <li>
                  <em>
                ...
                <li>
                  <em>Resolve disputes and troubleshoot problems.</em>
                </li>
                <li>
                  <em>Respond to product and customer service requests.</em>
                </li>
                <li>
                  <em>Send you a newsletter.</em>
                </li>
                <li>
                  <em>
                    Solicit support for the Siteand our mobile application.
                  </em>
                </li>
              </ul>
            </section>
            <section>
              ...
              <p>
                <em>
                  ...
                  by any applicable law, rule, or regulation. This includes
              ...
              <p>
                <em>
                  Marketing Communications With your consent, or with an
                  opportunity for you to withdraw consent, we may share your
              ...
              <p>
                <em>
                  Interactions with Other Users If you interact with other users
                  of the Site [and our mobile application], those users may see
              ...
              <p>
                <em>
                  Online Postings When you post comments, contributions or other
                  content to the Site [or our mobile applications], your posts
              ...
              <p>
                <em>
                  Social Media Contacts If you connect to the Site [r our mobile
                  application through a social network, your contacts on the
              ...
              <p>
                <em>
                  Other Third Parties We may share your information with
                  advertisers and investors for the purpose of conducting
              ...
              <p>
                <em>
                  Sale or Bankruptcy If we reorganize or sell all or a portion
                  of our assets, undergo a merger, or are acquired by another
                  entity, we may transfer your information to the successor
                  entity. If we go out of business or enter bankruptcy, your
                  information would be an asset transferred or acquired by a
                  third party. You acknowledge that such transfers may occur and
                  that the transferee may decline honor commitments we made in
                  this Privacy Policy.
                </em>
              </p>
            ...
            <section>
              ...
              <p>
                <em>
                  ...
                  mobile application and improve your experience. When you
                  access the Site [or our mobile application], your personal
              ...
              <p>
                <em>
                  Internet-Based Advertising Additionally, we may use
                  third-party software to serve ads on the Site [and our mobile
                  application], implement email marketing campaigns, and manage
                  other interactive marketing initiatives. This third-party
                  software may use cookies or similar tracking technology to
                  help manage and optimize your online experience with us. For
                  more information about opting-out of interest-based ads, visit
                  the Network Advertising Initiative Opt-Out Tool or Digital
              ...
              <p>
                <em>
                  Website Analytics We may also partner with selected
                  third-party vendors[, such Google Analytics, to allow tracking
                  ...
                  third-party vendors. You are encouraged to review their
                  privacy policy and contact them directly for responses to your
                  questions. We do not transfer personal information to these
                  third-party vendors. However, if you do not want any
                  information to be collected and used by tracking technologies,
                  you can visit the third-party vendor or the Network
            ...
            <section>
              ...
              <p>
                <em>
                  ...
                  and collected. No uniform technology standard for recognizing
                  ...
                  Policy./Most web browsers and some mobile operating systems
                  and our mobile applications include a Do-Not-Track (“DNT”)
                  feature or setting you can activate to signal your privacy
                  preference not to have data about your online browsing
                  activities monitored and collected. If you set the DNT signal
            ...
            <section>
              ...
              <p>
                <em>
                  ...
                  have a registered account with the Site or our mobile
                  application, you have the right to request removal of unwanted
                  data that you publicly post on the Site [or our mobile
                  application]. To request removal of such data, please contact
                  ...
                  not publicly displayed on the Site [or our mobile
            ...
            <section>
              ...
              <p>
                <em>
                  JohnsonConcept, LLC dba Cannapages.com PO Box 100810 Denver,
                  CO 80250 (800) 699-8169 info@cannapages.com
                </em>
              </p>
            </section>
          </div>
