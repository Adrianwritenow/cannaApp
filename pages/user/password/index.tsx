...
export default function ForgotPassword() {
  ...
  const [dispatchAxios, { success }] = useAxios();
  const initialValues = {
    email: '',
  };
          ...
          <div className="flex flex-col justify-start py-12 px-4 bg-white">
            <div className="mx-auto max-w-lg">
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full bg-green text-white hover:bg-green-600 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2"
                >
                  Reset Your Password
                </button>

                <Link href="/login">
                  <a className="w-full bg-white text-green hover:bg-green-600 hover:text-white flex justify-center py-2 px-4 border border-green rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2">
                    Back to Log In
                  </a>
                </Link>
              </form>
